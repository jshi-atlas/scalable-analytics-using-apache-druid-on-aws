...
if (
  druidConfig.useFipsEndpoint &&
  !fipsEnabledRegions.includes(region.toLowerCase())
) {
  throw new Error(
    ...
    "/SecurityGroup/Resource": [
      {
        id: "W40",
        reason:
          "This project requires to download installation files from internet and S3",
      },
      {
        id: "W5",
        reason:
      ...
      [
        {
          id: "W12",
          reason:
            "Default IAM policy implicitly generated by CDKBucketDeployment.",
        },
      ],
    "/druid-vpc/inner-vpc/PublicSubnetSubnet[0-9]+/Subnet$": [
      {
        id: "W33",
        reason:
          "Public IP address assignment is needed for bastion host launched in the public subnet",
      },
    ],
    "/canary/ServiceRole/Resource": [
      {
