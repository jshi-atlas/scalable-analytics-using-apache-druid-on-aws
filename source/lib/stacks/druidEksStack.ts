      ...
      new CfnNagResourcePathRulesSuppressionAspect({
        ...
        "/alb-sa/Role/DefaultPolicy/Resource": [
          ...
          },
          {
            id: "W76",
            reason:
              "This role is created by ALB controller. THe SPCM is not an issue.",
          },
        ],
        ...
        "/Custom::AWSCDKOpenIdConnectProviderCustomResourceProvider/Role": [
          {
            id: "W11",
            reason:
              "This role is implicitly created by CDK. Resource * is required for it to function.",
          },
        ],
        "/Custom::AWSCDKOpenIdConnectProviderCustomResourceProvider/Handler": [
          {
            id: "W58",
            reason:
              "Lambda function already has the correct permissions to write CloudWatch logs.",
          },
          {
            id: "W89",
            reason:
              "Lambda function is not necessarily needed to deploy in a VPC.",
          },
          {
            id: "W92",
            reason:
              "Lambda functions donot need to define ReservedConcurrentExecutions.",
          },
        ],
        "/AWSCDKCfnUtilsProviderCustomResourceProvider/Handler": [
          ...
          },
          {
            id: "W92",
            reason:
              "Lambda functions do not need to define ReservedConcurrentExecutions.",
          },
        ],
        ...
        "/eks-cluster/ControlPlaneSecurityGroup/Resource": [
          {
            id: "W5",
            reason:
              "This is to allow the druid services to download the required dependencies.",
          },
          {
            id: "W40",
            reason:
