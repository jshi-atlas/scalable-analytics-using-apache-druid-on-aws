...
public class BasicAuthenticationRoleProviderTest {
    ...
    public void setUp() throws ClientProtocolException, IOException {
        ...
        when(xbasicConfig.getDruidBaseUrl()).thenReturn(server.url("/").toString());
        when(xbasicConfig.getDruidUsername()).thenReturn("username");
        when(xbasicConfig.getDruidPassword()).thenReturn(mock(PasswordProvider.class));
    }
