 ...
 */
@Path(XbasicCallbackResource.SELF_URL)
@LazySingleton
public class XbasicCallbackResource {
    public static final String SELF_URL = "/druid-ext/druid-xbasic/callback";

    private static final Logger LOGGER = new Logger(XbasicCallbackResource.class);

    @Inject
    public XbasicCallbackResource() {
        // do nothing
    }
